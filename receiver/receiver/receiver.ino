...
ISR(TIMER1_COMPA_vect) {
    ...
    // se nao acabou o quadro (size=11), incremente o bit atual
    if (current_bit <= 10) {
        current_bit++;
    } 
    // se acabou o quadro, retorne o bit para 0
    else {
        current_bit = 0;
    }
}
...
void loop() {
    ...
    // Fim da transmissão
        ...
        Serial.println(bufferToChar(buffer));
